...
Got a baseline mean streams with pyro Gaussian Process. Uncertainty calculated with rolling MAD with a large window 100 days.
Finally, I looked for elevated listening (outside uncertainty) that occured for 3 days or more concurrent to find suspicious spikes.
